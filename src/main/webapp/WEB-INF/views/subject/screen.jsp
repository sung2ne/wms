        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="box" id="formBox">
                    <div class="box-header">
                        <h3 class="box-title">교과목 <span id="formText">등록</span></h3>
                    </div>
                    <div class="box-body">
                        <form id="form">
                            <table class="table table-bordered table-hover">
...
<script>
    ...
    function viewEditData(data) {
        ...
        // 수정
        $('#form input[name=subjectName]').val(data.subjectName);
    ...
    // 목록
    let departmentTable = $('#subjectTable').DataTable({
        language: lang_kor,
        paging: true,
        pageLength: 20,
        info: true,
        ...
        createdRow: function ( row, data, dataIndex, cells ) {
            $(row).attr('data-subject-idx', data.subjectIdx);
        },
    });
    ...
    $('#subjectTable tbody').on('click', 'tr', function () {
        sideWork = 'view';
        subjectIdx = $(this).data('subject-idx');

        $.ajax({
            url: '<c:url value="/subject/view"/>',
            type: 'GET',
            data: {
