        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">대학/학부 목록</h3>
            ...
            <div class="col-md-4">
                ...
                <div class="box hidden" id="viewBox">
                    <div class="box-header">
                        <h3 class="box-title">대학/학부 정보</h3>
                    </div>
                    <div class="box-body">
                ...
                <div class="box" id="formBox">
                    <div class="box-header">
                        <h3 class="box-title">대학/학부 <span id="formText">등록</span></h3>
                    </div>
                    <div class="box-body">
                        <form id="form">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th>대학/학부</th>
                                    <td><input type="text" class="form-control" name="collegeName"></td>
                                </tr>
                                <tr>
                                    <th>전화번호</th>
                                    <td><input type="text" class="form-control" name="collegePhone"></td>
                                </tr>
                            </table>
...
<script>
    ...
    function viewEditData(data) {
        ...
        $('#collegePhone').text(data.collegePhone);
        ...
        // 수정
        $('#form input[name=collegeName]').val(data.collegeName);
        $('#form input[name=collegePhone]').val(data.collegePhone);
    ...
    let collegeTable = $('#collegeTable').DataTable({
        ...
        createdRow: function ( row, data, dataIndex, cells ) {
            $(row).attr('data-college-idx', data.collegeIdx);
        },
    });

    // 보기
    $('#collegeTable tbody').on('click', 'tr', function () {
        sideWork = 'view';
        collegeIdx = $(this).data('college-idx');

        $.ajax({
            url: '<c:url value="/college/view"/>',
            type: 'GET',
            data: {
